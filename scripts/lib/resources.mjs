...
export const PATHS = [
  ...
  },
  {
    ...
    steps: [
      ...
      { name: "Emergent Abilities of LLMs", track: "academic_papers", why: "The claim that new capabilities appear discontinuously with scale." },
      { name: "Are Emergent Abilities a Mirage?", track: "academic_papers", why: "The counterargument—read both and decide what scale really buys." },
      ...
      { name: "Instruct-GPT-3", track: "academic_papers", why: "How preference learning turned base models into instruction-following assistants." },
      { name: "Training a Helpful and Harmless Assistant with RLHF", track: "academic_papers", why: "A full RLHF safety pipeline, with the helpfulness-harmlessness tension made explicit." },
      ...
      { name: "AI Safety via Debate", track: "academic_papers", why: "Another oversight bet: use AI systems to check claims humans can't evaluate directly." },
      ...
      { name: "Alignment Forum", track: "websites", why: "Where the research conversation continues past the published papers." },
      { name: "AGI Safety Fundamentals", track: "courses", why: "A structured curriculum to consolidate all of the above and find your research direction." },
    ],
  },
  {
    slug: "engineers",
    ...
    steps: [
      { name: "[1hr Talk] Intro to Large Language Models", track: "youtube", why: "Karpathy's one-hour grounding in how the systems you'll be securing actually work." },
      ...
      { name: "Backdoor Attacks", track: "academic_papers", why: "The supply-chain threat model: poisoned training data as an attack surface." },
      { name: "Sleeper Agents: Training Deceptive LLMs that Persist Through Safety Training", track: "academic_papers", why: "Backdoors meet alignment: deceptive behavior that survives safety training." },
      { name: "TruthfulQA", track: "academic_papers", why: "A benchmark that shows measuring truthfulness is harder than it looks." },
      { name: "MMLU Benchmark", track: "academic_papers", why: "The capability eval you'll see cited everywhere—know what it does and doesn't measure." },
      { name: "Let's Verify Step by Step", track: "academic_papers", why: "Process supervision: rewarding reasoning steps instead of just final answers." },
      ...
      { name: "Distill", track: "websites", why: "Beautifully explained ML research—the interpretability classics live here." },
      { name: "Scaling Interpretability", track: "youtube", why: "Where mechanistic interpretability is headed as models keep growing." },
      { name: "Model Organisms of Misalignment", track: "academic_papers", why: "Building deliberately misaligned models so alignment failures can be studied directly." },
      { name: "Intro to ML Safety", track: "courses", why: "A structured, technical course tying robustness, monitoring, and alignment together." },
